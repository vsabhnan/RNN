...
The file main.py can be run to replicate the results in the report. It calls functions from the remaining py files to run the various experiments. Please make sure to edit the path with the input dataset “IMDB Dataset.csv” to whereever it is stored. 
